...
(function () {
  ...
  Object.assign(badge.style, {
    ...
    fontSize: '14px',
    fontWeight: '600',
    boxShadow: '0 8px 30px rgba(167, 225, 105, 0.35)',
    zIndex: '9999',
  ...
  badge.addEventListener('mouseenter', () => {
    ...
    badge.style.boxShadow = '0 12px 40px rgba(167, 225, 105, 0.5)';
  });

  badge.addEventListener('mouseleave', () => {
    badge.style.transform = 'translateY(0) scale(1)';
    badge.style.boxShadow = '0 8px 30px rgba(167, 225, 105, 0.35)';
  });
